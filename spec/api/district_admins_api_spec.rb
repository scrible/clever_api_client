...
# Unit tests for SwaggerClient::DistrictAdminsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DistrictAdminsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::DistrictAdminsApi.new
  end
  ...
  describe 'test an instance of DistrictAdminsApi' do
    it 'should create an instance of DistrictAdminsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::DistrictAdminsApi)
    end
  end
